...
/*
    ...
    Como se trata de uma lista ordenada, os elementos são inseridos na lista em ordem crescente. Foram aproveitadas as implementações de lista duplamente encadeada,
    adicinonando a função inserir(), que faz chamadas a inserir_inicio(), inserir_meio() e inserir_fim() conforme a necessidade/contexto do algoritmo.
...
// Protótipo da função para inserção de elemento na lista. Tem como parâmetro um ponteiro para ponteiro de nó. Seu retorno é genérico(void).
